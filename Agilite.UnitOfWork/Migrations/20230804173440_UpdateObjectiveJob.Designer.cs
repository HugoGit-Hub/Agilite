...
namespace Agilite.UnitOfWork.Migrations
{
    ...
    [Migration("20230804173440_UpdateObjectiveJob")]
    partial class UpdateObjectiveJob
    {
        /// <inheritdoc />
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("JobObjective", b =>
                {
                    b.Property<int>("JobsIdJob")
                        .HasColumnType("int");

                    b.Property<int>("ObjectivesIdObjective")
                        .HasColumnType("int");

                    b.HasKey("JobsIdJob", "ObjectivesIdObjective");

                    b.HasIndex("ObjectivesIdObjective");

                    b.ToTable("JobObjective");
                });
            ...
            modelBuilder.Entity("JobObjective", b =>
                {
                    b.HasOne("Agilite.Entities.Entities.Job", null)
                        .WithMany()
                        .HasForeignKey("JobsIdJob")
                        .OnDelete(DeleteBehavior.Cascade)
                        .IsRequired();
